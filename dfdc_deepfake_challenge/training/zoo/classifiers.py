...
encoder_params = {
    ...
    #     "features": 1536,
    #     "init_op": EfficientNet.from_pretrained('efficientnet-b3')
    # },
    ...
    #     "features": 1792,
    #     "init_op": EfficientNet.from_pretrained('efficientnet-b4')
    # },
    "tf_efficientnet_b5_ns": {
        "features": 2048,
        "init_op": EfficientNet.from_pretrained('efficientnet-b5')
    },
    ...
    #     "features": 2304,
    #     "init_op": EfficientNet.from_pretrained('efficientnet-b6')
    # },
