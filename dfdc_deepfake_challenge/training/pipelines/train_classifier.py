...
def main():
    ...
    arg('--gpu', type=str, default='0,1', help='List of GPUs for parallel training, e.g. 0,1,2,3')
    arg('--output-dir', type=str, default='weights/')
    arg('--resume', type=str, default='')
    arg('--fold', type=int, default=0)
    arg('--prefix', type=str, default='classifier_')
    arg('--data-dir', type=str, default="/data/zyn/DeepFake")
    arg('--folds-csv', type=str, default='folds.csv')
    arg('--label_np', default='label.npy')
    ...
    for epoch in range(start_epoch, max_epochs):
        ...
        train_epoch(epoch, loss_functions, model, optimizer, scheduler, train_data_loader, summary_writer, conf,
